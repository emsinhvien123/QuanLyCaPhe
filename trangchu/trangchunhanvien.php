            ...
            <div class="shop-info">
                ...
                <?php
                    ...
                    if(isset($_SESSION['usernamenhanvien'])){
                        echo "Xin chào, ".$_SESSION['usernamenhanvien']."!";
                        echo "<br><a href='/QuanLyCaPhe/DANGNHAP2/logout.php'>Đăng xuất</a>";
                    } else {
                        echo '<a href="/QuanLyCaPhe/trangchu/trangchu2.html">Đăng nhập</a>';
                    }
                ?>
                </div>
            </div>
