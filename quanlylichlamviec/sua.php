            ...
            if (mysqli_num_rows($result) == 1) {
                ...
                <div class="container">
                    ...
                    <form action="sua.php?MaNV=<?php echo $MaNV; ?>" method="post">
                        ...
                        <div class="form-group">
                            <br><label for="TuNgay">Từ ngày:</label>
                            <input type="date-local" class="form-control" name="TuNgay" value="<?php echo date('Y/m/d', strtotime($row['TuNgay'])); ?>" required><br>
                        </div>
                        <div class="form-group">
                            <br><label for="DenNgay">Đến ngày:</label>
                            <input type="date-local" class="form-control" name="DenNgay" value="<?php echo date('Y/m/d', strtotime($row['DenNgay'])); ?>" required><br>
                        </div>
