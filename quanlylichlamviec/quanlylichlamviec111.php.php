        ...
        <!-- Navigation Bar -->
            <nav>
                <ul>
                    ...
                    <li><a href="quanlylichlamviec.php">Lịch làm việc</a></li>
                    ...
                    <li><a href="../trangchu/trangchuquanly.php">Quay lại</a></li>
                ...
                <div class="menu-list" id="menu-list">
                    ...
                    <a href="quanlylichlamviec.php">Lịch làm việc</a>
                    ...
                    <a href="../trangchu/trangchuquanly.php">Quay lại</a>
                </div>
            </nav>
    </header>
    <div class="container">
        <br>
        <h2>Lịch làm việc</h2><br>
        <!-- <form method="get">
