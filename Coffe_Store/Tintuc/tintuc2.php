...
<body>
                ...
                <div class="shop-info">
                    <div class="actions">
                        ...
                        if(isset($_SESSION['username'])){
                            ...
                            echo "<br><a href='/Coffe_Store/DANGNHAP/logout.php'>Đăng xuất</a>";
                        } else {
    ...
    <!-- Main Content -->
    <main>
        <p><h1>Giới thiệu các loại cà phê mới</h1>

            <div class="coffee-container">
                <div class="coffee-card">
                    <a href="frontend.html">
                    <img src="logo5.jpg" alt="Cà phê sữa đá">
                    <h3>Cà phê sữa đá</h3>
                    <p>Cà phê sữa Việt Nam khác biệt so với những nước trên thế giới. 
                        Nó mang nét mộc mạc, lắng đọng như người Việt, 
                        nhưng lại không kém phần ấn tượng bởi chính từ hương vị tinh tuý và đặc sắc. 
                        Đối với nhiều nơi sẽ dùng sữa tươi thưởng thức với cà phê, 
                        nhưng người Việt lại dùng sữa đặc, chúng làm cho hương vị cà phê đậm đà nguyên vẹn. 
                        Bên cạnh đó, cách pha cà phê sữa của Việt Nam lại rất đặc sắc</p>
                    </a>
                </div>
        
                <div class="coffee-card">
                    <img src="logo.png" alt="Cà phê Espresso">
                    <a href="frontend.html">
                    <h3>Cà phê Espresso</h3>
                    <p>Cafe Espresso (còn được gọi là cà phê kem), cách pha chế loại cà phê này rất cầu kỳ, 
                        bạn phải dùng nước nóng nén dưới áp suất cao qua bột cà phê được xay mịn. 
                        Espresso mang hương vị đậm đà, trên mặt có lớp bọt màu nâu tạo hương thơm và sự sang trọng cho cà phê. 
                        Đây là loại cà phê này rất đắng, đậm đặc và có lượng cafein cao.</p>
                    </a>
                </div>
                
                <div class="coffee-card">
                    <img src="logo2.jpg" alt="Cà phê Mocha">
                    <a href="frontend.html">
                    <h3>Cà phê Mocha</h3>
                    <p>Cafe Mocha có hương thơm nhẹ nhàng của cafe kết hợp với vị béo của kem và chocolate, 
                        không giống như Cappuccino hay Latte, 
                        một tách cafe Mocha mang đến cho người thưởng thức hương vị béo thơm của kem tươi cùng với vị ngậy của chocolate nóng.</p>
                    </a>
                </div>
            </div></p>
    </main>
