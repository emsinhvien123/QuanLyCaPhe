...
<body>
    ...
    <br>
        <p>
			<h1>Tin tức và sự kiện của quán cà phê Coffee</h1>
		
		<div class="container">
			<div class="card">
				<img src="logo4.png" alt="Tin tức 1" />
				<h2>Tin tức 1</h2>
				<p>Các loại cà phê mới được xuất hiện tại quán Coffee.</p>
				<a href="tintuc2.php">Xem chi tiết</a>
			</div>
			<div class="card">
				<img src="logo3.png" alt="Tin tức 2" />
				<h2>Tin tức 2</h2>
				<p>Giảm giá free sip cho mọi đơn hàng nhân ngày lẽ Halloween (Chỉ áp dụng ở Hà Nội).</p>
				<a href="tintuc3.php">Xem chi tiết</a>
			</div>
            <div class="card">
				<img src="logo9.png" alt="Tin tức 3" />
				<h2>Tin tức 3</h2>
				<p>Tuyển nhân viên phục vụ</p>
				<a href="tuyendung.php">Xem chi tiết</a>
			</div>
